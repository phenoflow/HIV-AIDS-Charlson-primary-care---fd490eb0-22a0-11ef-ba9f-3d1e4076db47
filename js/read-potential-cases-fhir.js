...
(async () => {
  ...
  await fs.writeFile("hiv-aids-charlson-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hiv-aids-charlson-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
